import { GolferMoneyRankings, GolferScores, RawGolferData } from 'src/types';
...
export const generateRankings = (players: RawGolferData[]) => {
  const golferScores: GolferScores = {};
  ...
  return { golfers: golferScores, golferRankings };
};
